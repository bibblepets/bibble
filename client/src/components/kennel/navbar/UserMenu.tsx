  ...
  return (
    <>
      <div className="flex flex-row items-center gap-4 w-64">
        <a
          href="/listing"
          className="border rounded-full shadow-md hover:shadow-xl active:scale-95 transition duration-300 text-sm px-4 py-2 text-neutral-500"
        >
          Make a listing
        </a>
        <a
        ...
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="border rounded-2xl shadow-md hover:shadow-xl active:scale-95 transition duration-300"
        >
